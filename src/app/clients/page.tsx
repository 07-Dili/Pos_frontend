...
export default function ClientsPage() {
    ...
    const performSearch = async () => {
        try {
            setLoading(true);
            const results = await clientService.search(searchTerm, searchField);
            setClients(results);
            setTotalPages(1);
                    ...
                    <form onSubmit={handleSearch} className="d-flex gap-2" style={{ flex: 1, maxWidth: '600px' }}>
                        ...
                        <div className="input-group">
                            <input
                                ...
                                placeholder={`Search clients by ${searchField}...`}
                                value={searchTerm}
                            ...
                            <table className="table table-striped table-hover">
                                <thead className="table-primary">
                                    <tr>
                                        ...
                                        <th className="text-center" style={{ width: '28%' }}>Name</th>
                                        <th className="text-center" style={{ width: '28%' }}>Email</th>
                                        <th className="text-center" style={{ width: '17%' }}>Phone</th>
                                        <th className="text-center" style={{ width: '19%' }}>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {clients.length === 0 ? (
