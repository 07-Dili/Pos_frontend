...
const UploadProductModal: React.FC<UploadProductModalProps> = ({ show, onClose, onSubmit }) => {
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header bg-primary text-white">
                            <h5 className="modal-title">Upload Products (TSV)</h5>
                            <button
                                type="button"
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="modal-body">
                                ...
                                <div className="alert alert-info">
                                    <small>
                                        <strong>Note:</strong> The TSV file should contain product data with proper formatting.
